...
if (knitr::is_html_output()) {
  cat("[![DOI](https://zenodo.org/badge/748342316.svg)](https://zenodo.org/badge/latestdoi/748342316)")
} else {
  cat("[DOI: 10.5281/zenodo.10854355](https://zenodo.org/badge/latestdoi/748342316)")
}
```
