# National Pupil Database {#sec-data-npd .unnumbered}
...
| Get Information about Schools (GIAS) | 2020 to 2022 | 
...
Unique Pupil Numbers (UPNs) have been returned to DfE by local authorities in the CLA module from 1st April 2005 and in the CIN module from 1st April 2009 (i.e., from when the CIN census began). Where a UPN is returned, the aPMR is available, enabling linkage to the NPD education records. Before April 2005, it is not possible to link education and the CLA datasets. It is also not possible to link social care and education records for children who were only in contact with children’s social care services before their UPN was assigned (e.g., for children who were a child in need or looked after before school age). Previous research has shown that 20% of children who are ever looked after during childhood are only looked after before age 5.[38]
